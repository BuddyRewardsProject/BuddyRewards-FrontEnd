...
import logoM from "../assets/img/logoMB.svg";
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="paddingTop15 container">
        <h2>เมนูลัด</h2>
        </div>
          ...
          <div class="row row-cols-2 row-cols-xs-2 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 g-3">
            <div class="cols-2 ">
              <Link to="/merchant/branch/webPOS">
                <div className="menuCard">
                  ...
                  <h2 className="card-title mt-2 mb-2 text-center">WebPOS</h2>
            ...
            <Link to="/merchant/branch/Dashboard">
              <div className="menuCard">
                ...
                <h2 className="card-title mt-2 mb-2 text-center">Dashboard</h2>
